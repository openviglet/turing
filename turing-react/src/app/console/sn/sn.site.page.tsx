                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    <NavLink to="/console">
                      ...
                      {isNew ? (<span className="text-base font-semibold">New Semantic Navigation</span>) : (<span className="text-base font-semibold">{snSite.name}</span>)}
                    </NavLink>
                  </SidebarMenuButton>
                      ...
                      <form>
                        ...
                        <DialogContent className="sm:max-w-[450px]">
                          ...
                          <p className="grid gap-4">
                            This action cannot be undone. This will permanently delete the {snSite.name} search engine.
                          </p>
                          <DialogFooter>
                  ...
                  <SidebarMenu>
                    {data.navMain.map((item) => (
                      <SidebarMenuItem key={item.title} >
                        <SidebarMenuButton tooltip={item.title} isActive={pathname.startsWith(urlBase + item.url)} asChild>

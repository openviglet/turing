...
public interface TurConnectorIndexingRepository
        ...
        List<TurConnectorIndexingModel> findByDependenciesReferenceId(int referenceId);
        ...
        List<TurConnectorIndexingModel> findBySourceAndProviderAndTransactionIdNotAndStandalone(
                        String source, String provider, String transactionId, boolean standalone);

        List<TurConnectorIndexingModel> findByObjectIdAndSourceAndEnvironmentAndProvider(

...
public class TurConnectorIndexingService {
        ...
        public List<TurConnectorIndexingModel> findAllByProviderAndObjectIdIn(String provider,
                ...
                return turConnectorIndexingRepository.findAllByProviderAndObjectIdIn(provider,
                                objectIds);
        }

        public void deleteByProviderAndSourceAndObjectIdIn(String provider, String source,
                        Collection<String> objectIds) {
                turConnectorIndexingRepository.deleteByProviderAndSourceAndObjectIdIn(provider,
                                source, objectIds);
        ...
        public void update(TurJobItemWithSession turSNJobItemWithSession,
                ...
                List<TurConnectorIndexingModel> managedList = turConnectorIndexingList.stream()
                                .map(indexing -> turConnectorIndexingRepository
        ...
        public List<TurConnectorIndexingModel> getList(
        ...
        public List<TurConnectorIndexingModel> getShouldBeDeIndexedList(
        ...
        private HashSet<TurConnectorDependencyModel> getDependencies(
                        TurJobItemWithSession turSNJobItemWithSession,
        ...
        private TurConnectorIndexingModel createTurConnectorIndexing(
                ...
                TurConnectorIndexingModel turConnectorIndexingModel = TurConnectorIndexingModel
                ...
                turConnectorIndexingModel.setDependencies(getDependencies(turSNJobItemWithSession,
        ...
        public List<TurConnectorIndexingModel> getBySourceAndProvider(String source,
                        String provider) {
                return turConnectorIndexingRepository
        ...
        public List<String> getObjectIdList(String source, String environment,
                ...
                return turConnectorIndexingRepository.findAllObjectIds(source,
        ...
        public Collection<String> validateObjectIdList(String source, String environment,
                ...
                return turConnectorIndexingRepository.distinctObjectId(source,

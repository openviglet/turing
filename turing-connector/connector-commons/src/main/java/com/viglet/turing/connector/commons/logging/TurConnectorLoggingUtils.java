...
public class TurConnectorLoggingUtils {
    ...
    public static void setSuccessStatus(TurSNJobItem turSNJobItem, TurConnectorSession session,
        ...
        TurLoggingIndexingLog.setStatus(TurLoggingIndexing.builder().contentId(turSNJobItem.getId())
                .url(turSNJobItem.getStringAttribute(URL))
                .environment(turSNJobItem.getEnvironment()).locale(turSNJobItem.getLocale())
                .status(status).resultStatus(TurLoggingStatus.SUCCESS)
    ...
    public static void setSuccessStatus(TurJobItemWithSession turSNJobItemWithSession,
            TurIndexingStatus status) {
        setSuccessStatus(turSNJobItemWithSession.turSNJobItem(), status);
    }

    public static void setSuccessStatus(TurSNJobItem turSNJobItem, TurIndexingStatus status) {
        TurLoggingIndexingLog.setStatus(TurLoggingIndexing.builder().contentId(turSNJobItem.getId())
                .url(turSNJobItem.getStringAttribute(URL))
                .environment(turSNJobItem.getEnvironment()).locale(turSNJobItem.getLocale())
                .status(status).resultStatus(TurLoggingStatus.SUCCESS)

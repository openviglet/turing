...
public class TurAemExtHtml2Text implements TurAemExtAttributeInterface {
    ...
    public TurMultiValue consume(TurAemTargetAttr turAemTargetAttr,
        ...
        if (turAemSourceAttr.getName() != null && aemObject != null
            ...
            return TurMultiValue.singleItem(TurCommonsUtils.html2Text(
                    aemObject.getAttributes().get(turAemSourceAttr.getName()).toString()));
        }

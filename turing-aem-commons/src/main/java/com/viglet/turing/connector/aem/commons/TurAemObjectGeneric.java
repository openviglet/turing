...
@Slf4j
@ToString
public class TurAemObjectGeneric {
    ...
    public TurAemObjectGeneric(String nodePath, JSONObject jcrNode) {
        this(nodePath, jcrNode, TurAemEvent.NONE);
    }

    public TurAemObjectGeneric(String nodePath, JSONObject jcrNode, TurAemEvent event) {
